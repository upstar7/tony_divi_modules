	...
	if(class_exists("ET_Builder_Module")){
		class ET_Builder_Module_Carousel extends ET_Builder_Module {
			function init() {
				...
				$this->slug            = 'et_pb_slick_slider_ty';
				$this->child_slug      = 'et_pb_slick_slide_ty';
			...
			function shortcode_callback( $atts, $content = null, $function_name ) {
				...
				$output = sprintf(
					'<div class="et_pb_module et_pb_slick_slider_ty">
						<div class="slick-carousel">
							%1$s
						</div> <!-- .et_pb_slides -->
					</div> <!-- .et_pb_slick_slider_ty -->
					',
					$content
				);
		...
		class ET_Builder_Module_Carousel_Item extends ET_Builder_Module {
			function init() {
				...
				$this->slug                        = 'et_pb_slick_slide_ty';
				$this->type                        = 'child';
...
add_action('et_builder_ready', 'TY_Carousel_Module');