...
function TY_Choose_Product() {
	if(class_exists("ET_Builder_Module")){
		class ET_Builder_Module_Product_Choose extends ET_Builder_Module {
			function init() {
				$this->name = esc_html__( 'Selected products', 'et_builder' );
			...
			function get_fields() {
				$fields = array(
					'include_products' => array(
						'label'            => __( 'Products to display', 'et_builder' ),
...
add_action('et_builder_ready', 'TY_Choose_Product');
