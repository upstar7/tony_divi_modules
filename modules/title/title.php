<?php
/**
 * @package TY_Divi_Custom_Divi_Title
 * @version 1.0.0
 */
    ...
    if(class_exists("ET_Builder_Module")){
        ...
        class ET_Builder_Module_Title extends ET_Builder_Module {
            ...
            function get_fields() {
                $fields = array(
                    'title_level' => array(
                        ...
                        'tab_slug'          => 'advanced',
                        'toggle_slug'       => 'text',
                        'description'       => esc_html__( 'Choose the title level', 'et_builder' ),
                    ),
            ...
            function shortcode_callback( $atts, $content = null, $function_name ) {
                ...
                $output = sprintf(
                    '<div%3$s class="et_pb_TY_title%2$s%4$s">
                        <div class="et_pb_TY_title_inner">
...
add_action('et_builder_ready', 'TY_Title_Module');